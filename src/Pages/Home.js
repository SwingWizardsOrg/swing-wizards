      ...
      <section className="hero">
        <div className="container mx-auto p-4">
          ...
          <div className="flex flex-wrap justify-center gap-10">
            <a
              href="/login"
              className="px-5 py-3 bg-blue-900 hover:bg-blue-950 text-white rounded-xl"
            >
              LOG IN
            </a>
            <a
              href="/register"
              className="px-5 py-3 bg-red-700 hover:bg-red-600 text-white rounded-xl"
            >
              SIGN UP
            </a>
          </div>
          ...
          <div className="flex flex-wrap justify-evenly text-center items-center p-4 gap-5">
            <div className="border-8 border-blue-950 p-4 rounded-3xl">
              ...
              <div className="space-y-3">
                ...
                <button className="px-5 py-2 bg-blue-950  hover:bg-blue-900 rounded-lg">
                  <a
